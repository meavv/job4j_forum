...
public class PostControlTest {
    ...
    @Test
    @WithMockUser
    public void whenGetNew() throws Exception {
        this.mockMvc.perform(get("/new?id=1"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(view().name("edit"));
    }
    ...
    public void shouldReturnDefaultMessage() throws Exception {
        ...
        params.add("name", "Куплю ладу-грант. Дорого.");
        ...
        System.out.println("rsl " + argument.getValue());
        MatcherAssert.assertThat(argument.getValue().getName(), is("Куплю ладу-грант. Дорого."));
    }

    @Test
    @WithMockUser
    public void whenReplacePost() throws Exception {
        MultiValueMap<String, String> params = new LinkedMultiValueMap<>();
        params.add("id", "0");
        ...
        ArgumentCaptor<Post> argument = ArgumentCaptor.forClass(Post.class);
        verify(posts).add(argument.capture());
        MatcherAssert.assertThat(argument.getValue().getName(), is("newName"));
    }
